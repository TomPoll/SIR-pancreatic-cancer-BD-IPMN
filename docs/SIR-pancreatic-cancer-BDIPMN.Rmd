...
```{r Dataset read, echo=FALSE, message=FALSE, warning=FALSE}
...
df <- tibble(
  ...
  ID = c(1:2000),
  Sex = sample(c("M", "F"), size = 2000, replace = TRUE),
  OBS = sample(c(0,1), size = 2000, replace = TRUE))
```
...
agegroup <- c("0-4", "5-9", "10-14", "15-19", "20-24", "25-29", "30-34", "35-39", "40-44", "45-49", "50-54", "55-59", "60-64", "65-69", "70-74", "75-79", "80-85", "85+")
